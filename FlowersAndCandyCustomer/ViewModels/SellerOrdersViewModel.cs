...
namespace FlowersAndCandyCustomer.ViewModels
{
    ...
    public class SellerOrdersViewModel : INotifyPropertyChanged
    {
        private bool _isBusy;
        private const int PageSize = 1;
        readonly SellerOrders _dataService = new SellerOrders();
        public static int rowCount = 0;
        public InfiniteScrollCollection<OrderSeller> Items { get; }
        ...
        public SellerOrdersViewModel(string type)
        {

            Items = new InfiniteScrollCollection<OrderSeller>
            {
                OnLoadMore = async () =>
                {
                    IsBusy = true;
