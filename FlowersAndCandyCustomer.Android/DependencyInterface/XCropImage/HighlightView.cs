...
namespace FlowersAndCandyCustomer.Droid.SourceCode.XCropImage
{
    public class HighlightView
    {
        ...
        private void Init()
        {
            ...
            _resizeDrawableWidth = ContextCompat.GetDrawable(Android.App.Application.Context, Resource.Drawable.camera_crop_width);
            _resizeDrawableHeight = ContextCompat.GetDrawable(Android.App.Application.Context, Resource.Drawable.camera_crop_height);
        }
